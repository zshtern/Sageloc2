...
@IonicPage()
@Component({
  selector: 'page-plugin-background-geolocation-lt-settings',
  templateUrl: 'plugin-background-geolocation-lt-settings.html',
})
export class PluginBackgroundGeolocationLtSettingsPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PluginBackgroundGeolocationLtSettingsPage');
  }
